...
\033[47;34m                 欢迎使用mengshare免流一键脚本                     \033[0m
\033[47;34m                   mengshare                                     \033[0m
\033[47;34m                         系统启动中                             \033[0m
\033[47;34m================================================================\033[0m";
echo
...
function pre_install(){
    ...
    echo "请输入连接密码"
    read -p "(默认密码: mengshare):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="mengshare"
    echo
    echo "---------------------------"
    ...
    echo -e "确认本机IP\t\033[32m$IP\033[0m"
    echo
    #Current folder
    cur_dir=`pwd`
    cd $cur_dir
...
function install_ss(){
    ...
    if [ -f /usr/bin/pip ]; then
        ...
        echo -e "服务IP: \033[41;37m ${IP} \033[0m"
        echo -e "连接端口: \033[41;37m ${shadowsocksport} \033[0m"
        echo -e "连接密码: \033[41;37m ${shadowsockspwd} \033[0m"
        echo -e "本地监听IP: \033[41;37m 127.0.0.1 \033[0m"
        echo -e "监听端口: \033[41;37m 1080 \033[0m"
        echo -e "加密方式: \033[41;37m aes-256-cfb \033[0m"
        echo
        echo "欢迎使用mengshare一键脚本"
        echo "搭建完毕，感谢您对mengshare的支持"
        echo
        exit 0
    else
        echo
